<?php include "header.php"; ?>
    <div class="container">
        <div class="col-md-12">
            <center>
            <h1><strong> Resep Aneka Olahan Mi yang Lezat dan Menggugah Selera, Kuah Hingga Goreng </h1>
            </center>
         </br>
        </br>
    		<blockquote class="blockquote"> 
        	<p> <h3> Resep aneka olahan mi di bawah ini bisa Anda coba untuk buat di rumah. Mi merupakan bahan makanan populer yang banyak digemari oleh masyarakat dari segala usia. Selain rasanya yang lezat, mi cukup mudah diolah dan dikreasikan dengan berbagai macam bahan pendamping.
            Banyak sekali pilihan masakan mie yang unik dan menggugah selera. Mulai dari yang berkuah hingga goreng. Sebagai inspirasi, berikut merdeka.com membagikan beberapa resep olahan mi yang lezat dilansir dari laman BrilioFood dan berbagai </h3> </p>
            
				<h3 class="wp-block-heading"> <strong> 1. Mie Goreng Ndeso </strong> </h3> 
            		<br><img src="images/miendeso.jpg" width="1000px" height="500px">                  
         		...
         		<h3 class="wp-block-heading"> <strong> 2.Mie Laksa Singapore </strong> </h3> 
            		<br><img src="images/milaksasingapore.jpg" width="1000px" height="500px">
				...
				<h3 class="wp-block-heading"> <strong> 3. Mie Gomak Khas Medan</strong> </h3> 
					<br><img src="images/miegomak.jpg" width="1000px" height="500px">
				...
				<h3 class="wp-block-heading"> <strong>4.Mie Kuah Santan </strong> </h3> 
					<br><img src="images/mikuahsantan.jpg" width="1000px" height="500px">
				...
				<h3 class="wp-block-heading"> <strong>5.Mie Ramen Goreng Ala Rumahan</strong> </h3> 
					<br><img src="images/mieramen.jpg" width="1000px" height="500px">
				...
				<h3 class="wp-block-heading"> <strong>6. Mie Goreng Kari </strong> </h3> 
					<br><img src="images/miekari.jpg" width="1000px" height="500px">
				...
				<h3 class="wp-block-heading"> <strong>7.  Mie Rebus Resto Padang </strong> </h3> 
					<br><img src="images/mierebusresto.jpg" width="1000px" height="500px">
				...
				<h3 class="wp-block-heading"> <strong> 8.  Mie Tek-Tek Spesial </strong> </h3> 
					<br><img src="images/mie tekspesial.jpg" width="1000px" height="500px">
