...
<div class="container">
    <div class="col-md-12">
        <center>
        <h1><strong> 4 Resep Olahan Daging Sapi,Mudah dibuat dan Dijamin Menggoyang Lidah </h1>
        </center>
    
    <blockquote class="blockquote">
        <p><h3> Punya banyak stok daging Idul adha, sudah menentukan ingin masak apa, belum nih, Beauties? Kalau masih bingung, kamu bisa mengecek resep olahan daging sapi di situs Cookingrara. Resep ini cenderung mudah diikuti dan bisa jadi stok untuk di rumah. 
            Yuk, simak 4 resep olahan daging sapi yang praktis dan enak dari Cookingrara. Simak Selengkapnya!</h3> </p>

            <p> <h2> <strong> 1. Sate Maranggi </h2> </p>
            <br><img src="images/satemaranggi.png" width="1008px" height="500px">
            ...
            <p> <h2> <strong> 2. Empal Serundeng  </h2>
                <br><img src="images/empalserundeng.png" width="1008px" height="500px">
              ...
              <p> <h2> <strong> 3. Kalio Daging & Ubi </h2>
                <br><img src="images/kaliodaging.png" width="1008px" height="500px">
            ...
            <p> <h2> <strong> 4.Rendang Daging </h2>
                <br><img src="images/rendang.png" width="1008px" height="500px">
             ...
             <p> <h3>  Membaca keempat resep di atas langsung jadi lapar, nggak sih, Beauties? Kira-kira dari keempat resep tersebut, Beauties mau masak yang mana, nih?  </h3> </p>
    </blockquote>
        </div>
    </div>
