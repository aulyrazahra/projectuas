...
<html lang="en">
  ...
  <!-- Jumbotron -->
      <div class="jumbotron jumbotron-fluid text-center">
        <div class="container">
          <h1 class="display-4"><span class="font-weight-bold">COOKING RARA FAVORIT </span></h1>
          <hr>
          <p class="lead font-weight-bold"> INI ADALAH MENU RESEP FAVORIT ANDA <br> 
          Enjoy Your Cooking</p>
        </div>
      </div>
  <!-- Akhir Jumbotron -->
  ...
  <!-- Navbar -->
      <nav class="navbar navbar-expand-lg  bg-dark">
        <div class="container">
        <a class="navbar-brand text-white" href="user.php"><strong>COOKINGRARA</strong> MY RECEPT FAVORITE</a>
  ...
  <!-- Menu -->
    <div class="container">
      <div class="judul-pesanan mt-5">
        ...
        <h3 class="text-center font-weight-bold">RESEP FAVORIT ANDA</h3>
