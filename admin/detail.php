...
<?php include "header.php"; ?>
	...
	<div class="container">	
		...
		<div class="item active">
								<img src="../images/banner.png" alt="" width="100%" height="1000%" > 
			...
			<div class="col-md-3">   <!-- Awal Tampilan Olahan Mie Goreng ndeso-->
				...
				<img src="../images/miendeso.jpg" style="width: 200px; height: 200px;" class="card-img-top">
					<div class="card-bod">
						...
						<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModalmiendeso1">
							Detail Resep
						</button>
						<a class="btn btn-danger" href="tampil-menu.php "role="button">
  <span class="glyphicon glyphicon-book"></span> Selengkapnya </a>

						<div class="modal fade" id="myModalmiendeso1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1">
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span> </button>		
										<h4 class="modal-title" id="myModalLabel1"> <strong> Mie Goreng Ndeso  </h4> </strong>
									</div>
		...
		<div class="col-md-3"> <!-- Awal Tampilan Olahan Kalio Daging & Ubi -->
			...
			<img src="../images/kaliodaging.png" style="width: 200px; height: 200px;" class="card-img-top">
				<div class="card-bod">
					...
					<a class="btn btn-danger" href="tampil=mrnu.php"role="button">
                    <span class="glyphicon glyphicon-book"></span> Selengkapnya </a>
