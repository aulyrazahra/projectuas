            ...
            <div class="col-md-12">
                ...
                ?>
                   <div class="form-group">
                        ...
                        <input type="hidden" name="menu_id" value="<?php echo $row['menu_id']?>" class="form-control">
                        <input type="number" name="menu_id" value="<?php echo $row['menu_id']?>" class="form-control">
                    </div>
                    <div class="form-group">
