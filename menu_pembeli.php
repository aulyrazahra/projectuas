...
<html lang="en">
  ...
  <div class="container">
    <div class="row mt-3">
        ...
        $query = mysqli_query($koneksi, 'SELECT id_menu, nama_menu, harga, gambar FROM produk');
        
        while ($result = mysqli_fetch_assoc($query)) :
        ?>
            <div class="col-md-3 mt-4">
                <div class="card border-dark">
                    <img src="upload/<?php echo htmlspecialchars($result['gambar']); ?>" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title font-weight-bold"><?php echo htmlspecialchars($result['nama_menu']); ?></h5>
